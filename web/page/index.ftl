...
<#--src="images/2015_contact.jpg"/></a><a href="index.php.html#%23%23"-->
<#--onClick="javascript:alert('院长信箱：dean_smse@tju.edu.cn');"-->
<#--class="floatRight"><img src="images/2015_login.jpg"/></a></div>-->
<#--<div class="mainRight"><a href="vote/index.php.html" target="_blank"><img src="images/mainTip.jpg"/></a></div>-->
<#--<div class="cb"></div>-->
<#--</div>-->
