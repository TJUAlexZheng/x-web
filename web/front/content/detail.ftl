...
<div class="middles" style="margin-top:18px;">
    ...
    <div id="sub_right">
        <div id="news_position">现在位置：<span class="news_index"><a href="/">首页</a></span> &gt;&gt; <span class="news_title"><a href="/content/${contentType.id}">${contentType.name}</a></span> &gt;&gt;
    <#if blog??>
        ${blog.title}
    <#elseif news??>
        ${news.title}
...
<div class="middles">
    ...
    <div id="footer">联系地址：天津市海河教育园区雅观道135号31号教学楼 [<a href="http://l.map.qq.com/11222015482?m" target="_blank">查看学院地图标注</a>]，邮政编码：300350<br>联系电话：022-85356663 传真：022-XXXXXXXX 电子邮件：dean_smse@tju.edu.cn</div>
</div>
</@layout>